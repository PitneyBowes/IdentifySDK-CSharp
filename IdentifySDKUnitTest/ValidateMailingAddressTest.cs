...
{
    [TestClass]
    public class ValidateMailingAddressTest
    {
        ...
        public void TestAsync()
        {
            try
            {
                ...
                identifyAddressService.IdentifyAPIRequestFinishedEvent += (object sender, WebResponseEventArgs<ValidateMailingAddressAPIResponse> eventArgs) =>
                {
                    try
                    {
                ...
                ValidateMailingAddressAPIRequest request = new ValidateMailingAddressAPIRequest(input, op);
                identifyAddressService.ValidateMailingAddressAsync(request);
