    ...
    public class ValidateMailingAddressProTest
    {
        ...
        public void getAddressProjsonTestAndCompareSDKResponseTest()
        {
            try
            {
                ...
                ValidateMailingAddressProAPIRequest request = new ValidateMailingAddressProAPIRequest(input, op);
                ValidateMailingAddressProAPIResponse response = identifyAddressService.ValidateMailingAddressPro(request);
                string sdkResponse = Utility.ObjectToJson<ValidateMailingAddressProAPIResponse>(response);

                String apiResponse = TestUtility.ValidateFromAPI(TEST_URL, "/identifyaddress/v1/rest/validatemailingaddresspro/", TEST_TOKEN, inputjsonAddresses, com.pb.identify.utils.Utility.contentType.json);
