...

{
    ...
    /// </summary>
    /// <seealso cref="com.pb.identify.oauth.OAuthService" />
    /// <seealso cref="com.pb.identify.oauth.BaseOAuthService" />
    public class BaseOAuthServiceImpl : OAuthService , BaseOAuthService {
        ...
        /// <summary>
        /// Invalidates the identify Service instance.
        /// </summary>
        void BaseOAuthService.invalidateIdentifyServiceManagerInstance()
    {
        if (getToken() != null)
        {
            setAuthToken(null);
